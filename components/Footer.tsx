...
import { WHATSAPP_URL, COMPANY_EMAIL, COMPANY_LOCATION, SOCIAL_LINKS, SITE_NAME } from '@/lib/constants'

const footerLinks = {
  services: [
    { label: 'Landing Page (RM99)', href: '/services#landing-page' },
    { label: 'Company Website', href: '/services#company-website' },
    ...
    <footer className="bg-slate-900 dark:bg-slate-950 text-slate-300 border-t border-slate-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-5">
              Affordable, professional website design for Malaysian businesses. We build fast, SEO-optimized websites that generate real leads.
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                ...
                >
                  <i className="fi fi-rr-envelope text-[16px] shrink-0" aria-hidden="true" />
                  {COMPANY_EMAIL}
                </a>
              </li>
              <li>
                <div className="flex items-start gap-2 text-sm text-slate-400">
                  <i className="fi fi-rr-marker text-[16px] shrink-0 mt-0.5" aria-hidden="true" />
                  {COMPANY_LOCATION}
                </div>
              </li>
            </ul>
      ...
      <div className="border-t border-slate-800 dark:border-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-slate-500">
          ...
          <p>Affordable web design in Malaysia 🇲🇾</p>
        </div>
      </div>
    </footer>
  )
