...
export const WHATSAPP_MESSAGE =
  "Hi Among Web, I'm interested in your web design services. Can you provide more info?"
export const WHATSAPP_URL = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(WHATSAPP_MESSAGE)}`

export const COMPANY_EMAIL = 'hello@amongweb.net'
export const COMPANY_LOCATION = 'Kuala Lumpur, Malaysia'

export const SOCIAL_LINKS = {
  instagram: 'https://instagram.com/amongweb',
  facebook: 'https://facebook.com/amongweb',
  linkedin: 'https://linkedin.com/company/amongweb',
}
